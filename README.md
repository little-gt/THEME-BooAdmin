...
[![BooAdmin](https://img.shields.io/badge/BooAdmin-v1.1.7-blue?style=for-the-badge)](https://github.com/little-gt/THEME-BooAdmin/releases)
...
> **⚠️ PRE 版本特别说明：** 1.1.7-PRE 是一个预发布版本，包含了即将发布的正式版本的功能预览。建议在测试环境中使用，不推荐在生产环境中部署。
> 
