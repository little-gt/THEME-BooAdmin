...
$header = '
<!-- Custom Styles -->
<link rel="stylesheet" href="' . $options->adminStaticUrl('css', 'normalize.css?v=1.1.12', true) . '">
<link rel="stylesheet" href="' . $options->adminStaticUrl('css', 'grid.css?v=1.1.12', true) . '">
<link rel="stylesheet" href="' . $options->adminStaticUrl('css', 'custom.css?v=1.1.12', true) . '">
<link rel="stylesheet" href="' . $options->adminStaticUrl('css', 'style.css?v=1.1.12', true) . '">
<link rel="stylesheet" href="' . $options->adminStaticUrl('css', 'nprogress.css?v=1.1.12', true) . '">
<!-- NProgress -->
