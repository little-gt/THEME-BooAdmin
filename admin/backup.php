        ...
        <div class="w-full max-none mx-auto">
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- 备份卡片 -->
                    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 flex flex-col h-full shadow-sm">
                    ...
                    <!-- 恢复卡片 -->
                    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200 flex flex-col h-full shadow-sm" id="backup-secondary">
                        <h3 class="text-lg font-semibold text-discord-text mb-4 flex items-center">
                        ...
                        <div id="from-upload" class="tab-content flex-1 flex flex-col">
                            <form action="<?php echo $actionUrl; ?>" method="post" enctype="multipart/form-data" class="flex-1 flex flex-col">
                                <div class="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-6 mb-6 hover:bg-gray-100 transition-colors cursor-pointer relative">
