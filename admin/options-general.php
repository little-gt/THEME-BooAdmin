    ...
    <div class="flex-1 overflow-y-auto p-4 md:p-8">
        <div class="w-full max-w-none mx-auto">
            ...
            <div class="flex space-x-1 mb-6 bg-gray-100 p-1 select-none overflow-x-auto settings-tabs">
                <a href="<?php $options->adminUrl('options-general.php'); ?>" class="flex-1 text-center px-4 py-2 text-sm font-medium transition-all bg-white text-discord-text"><?php _e('基本设置'); ?></a>
